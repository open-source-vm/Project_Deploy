...
def load_models():
    ...
    gru_model = load_model(os.path.join(MODEL_DIR, "gru_soh_model.keras"), compile=False)
    dqn_model = load_model(os.path.join(MODEL_DIR, "double_dqn_calibrated.keras"), compile=False)
